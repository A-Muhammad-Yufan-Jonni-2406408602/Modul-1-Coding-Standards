...
public class OrderServiceImplTest {
    ...
    void testUpdateStatusInvalidStatus() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> orderService.updateStatus(order.getId(), "ANTEK_ASING"));
    ...
    void testUpdateStatusInvalidId() {
        doReturn(null).when(orderRepository).findById("Monokotil");

        assertThrows(NoSuchElementException.class,
                () -> orderService.updateStatus("Monokotil", OrderStatus.SUCCESS.getValue()));
    ...
    void testFindByIdNotFound() {
        doReturn(null).when(orderRepository).findById("Monokotil");
        assertNull(orderService.findById("Monokotil"));
    }
